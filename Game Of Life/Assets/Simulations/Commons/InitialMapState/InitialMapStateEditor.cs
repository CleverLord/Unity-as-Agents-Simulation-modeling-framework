...
public class InitialMapStateEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Vector2Int newDimensions = EditorGUILayout.Vector2IntField("Map Dimensions", initialMapState.dimensions);
        ...
        {
            Undo.RecordObject(initialMapState, "Map Dimensions Change");
