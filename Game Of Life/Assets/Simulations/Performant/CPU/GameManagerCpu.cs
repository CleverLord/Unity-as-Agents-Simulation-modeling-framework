...
namespace GameOfLife.Performant.CPU
{
    ...
    public class GameManagerCpu : MonoBehaviour
    {
        ...
        public void UpdateLogic() {
            ...
            Action<GameOfLifeCell> updateLogicMethodDelegate = 
                updateLogicMethod == UpdateLogicMethod.Linq ? UpdateLogicParallelOperation : UpdateLogicParallelOperation_NoLinq;
            Parallel.ForEach(gridList, updateLogicMethodDelegate);
